use data;
insert into album (id,title,artist,release_year) values (1, 'Thriller', 'Michael Jackson', '1982');
insert into album (id,title,artist,release_year) values (2, 'Bad', 'Michael Jackson', '1987');
